...
int main() {
    ...
    cout << "Îäíîïîòî÷íàÿ ñóììà: " << sumSingle << endl;
    cout << "Âðåìÿ (1 ïîòîê): " << timeSingle << " ñåê" << endl << endl;
    ...
    cout << "Ìíîãîïîòî÷íàÿ ñóììà: " << sumMulti << endl;
    cout << "Âðåìÿ (" << numThreads << " ïîòîêîâ): " << timeMulti << " ñåê" << endl;
